...
// Register Custom Taxonomy
function project_technology_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Project Technologies', 'Taxonomy General Name', 'avash' ),
		'singular_name'              => _x( 'Project Technology', 'Taxonomy Singular Name', 'avash' ),
		'menu_name'                  => __( 'Project Technology', 'avash' ),
		'all_items'                  => __( 'All Items', 'avash' ),
		'parent_item'                => __( 'Parent Item', 'avash' ),
		'parent_item_colon'          => __( 'Parent Item:', 'avash' ),
		'new_item_name'              => __( 'New Item Name', 'avash' ),
		...
		'separate_items_with_commas' => __( 'Separate items with commas', 'avash' ),
		'add_or_remove_items'        => __( 'Add or remove items', 'avash' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'avash' ),
		'popular_items'              => __( 'Popular Items', 'avash' ),
		'search_items'               => __( 'Search Items', 'avash' ),
		'not_found'                  => __( 'Not Found', 'avash' ),
		'no_terms'                   => __( 'No items', 'avash' ),
	...
	register_taxonomy( 'project-technology', array( 'project' ), $args );

}
add_action( 'init', 'project_technology_taxonomy', 0 );
